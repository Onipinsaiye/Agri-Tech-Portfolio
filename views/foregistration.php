...
<body>
    <div class="covering" id="covering">
        <div class="header" id="header">
            <h3><em>Field Officer Registration</em></h3>
            <p>Enter your details in the field below to register.</p>
        </div>
        <form action="foregistration"  method="post" autocomplete="off"> <br>
            ...
            <input type="number" name="phoneNumber1" maxlength="11" autocomplete="off"> <br> <br>
            <label for="phoneNumber2">Phone Number 2 (optional)</label> <br>
            <input type="number" name="phoneNumber2" maxlength="11"> <br>
            <br>
